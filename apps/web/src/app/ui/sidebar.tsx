...
function Sidebar({
	...
	const sidebarContainerStyle = {
		transitionDuration: `${shellTransitionDuration}ms`,
		transitionTimingFunction: SIDEBAR_SHELL_EASING_BASELINE,
	} satisfies React.CSSProperties;
	const resolvedCollapsible = state === "collapsed" ? collapsible : "";
	...
	return (
		<div
			className="group peer relative hidden h-svh shrink-0 text-sidebar-foreground md:block"
			data-state={state}
