...
export type WalkInStepContentTone = "default" | "danger";

export interface WalkInStepContentLine {
	text: string;
	tone?: WalkInStepContentTone;
}

export interface WalkInVisibleProgressStep {
	step: WalkInStep;
	stepIndex: number;
}
...
export function getStepPreviewStateParam(stepId: PreviewableWalkInStepId) {
