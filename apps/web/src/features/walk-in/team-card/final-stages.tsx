...
interface WalkInTeamCardShareStageProps extends WalkInTeamCardStageCardProps {
	onBack: () => void;
...
interface WalkInTeamCardRevealStageProps extends WalkInTeamCardStageCardProps {
...
export function WalkInTeamCardShareStage(props: WalkInTeamCardShareStageProps) {
	const {
		headerLeftMetric,
		headerRightMetric,
		onBack,
				...
				>
					<div className="team-lineup-surface-scope flex h-full flex-col items-center px-6 py-5">
						...
						<div className="flex w-full items-center justify-between gap-3">
							<a
								href={shareUrl ?? "/walk-in-team-card"}
...
export function WalkInTeamCardRevealStage(props: WalkInTeamCardRevealStageProps) {
	const {
		archetypeLabel,
		headerLeftMetric,
		headerRightMetric,
...
export function WalkInTeamCardRevealFooter(props: {
...
export function WalkInTeamCardShareFooter(props: {
	onContinueToDashboard: () => void;
}) {
