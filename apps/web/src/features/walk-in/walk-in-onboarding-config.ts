...
export type WalkInPrimaryStep = (typeof WALK_IN_STEPS)[number];
export type WalkInStep = typeof UPLOAD_STEP | WalkInPrimaryStep;
export type WalkInStepId = WalkInStep["id"];
export type PreviewableWalkInStepId = Exclude<WalkInStepId, "card">;

export interface WalkInPreviewOption {
	label: string;
	value: string;
}
...
export const WALK_IN_STEP_PREVIEW_OPTIONS = {
	upload: [
