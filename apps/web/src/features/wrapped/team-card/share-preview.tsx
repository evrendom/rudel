...
export function WrappedTeamCardSharePreview(
	props: WrappedTeamCardSharePreviewProps,
) {
	const {
		appearance,
		backMetrics,
	...
	const shouldShowFrontBackSpread =
		spreadBackMetrics.length > 0;
...
function SharePreviewAnthropicLogo() {
	return (
		<svg viewBox="0 0 1200 1200" aria-hidden="true" className="h-4 w-4 shrink-0">
			<path
				fill="currentColor"
...
function SharePreviewCodexLogo() {
	return (
