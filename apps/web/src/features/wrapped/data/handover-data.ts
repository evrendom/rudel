import { WrappedHandoverSchema } from "@/features/wrapped/lib/handover-schema";

export const wrappedHandoverData = WrappedHandoverSchema.parse({
	version: "1",
	preview: {
		...
		// Reminder: these still need real storage before the inline red wrapped
		// copy warnings can be removed:
		// - user timezone / locale
		// - wrapped onboarding state
