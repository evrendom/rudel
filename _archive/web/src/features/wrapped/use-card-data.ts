...
import { buildWrappedHandover } from "@/features/wrapped/lib/build-handover";
import type { WrappedDataState } from "@/features/wrapped/lib/handover-schema";
import { authClient } from "@/lib/auth-client";
import { orpc } from "@/lib/orpc";

export function useWrappedCardData() {
	...
	const handover = buildWrappedHandover({
