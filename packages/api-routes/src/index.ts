...
export const SESSION_UPLOAD_SHRINK_REJECTED_MESSAGE =
	"This upload is smaller than the stored session and was refused to protect existing data. Inspect the transcript, then use `rudel upload --force-replace` only if the replacement is intentional.";
